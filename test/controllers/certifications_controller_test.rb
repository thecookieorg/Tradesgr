...
class CertificationsControllerTest < ActionController::TestCase
  ...
  test "should create certification" do
    assert_difference('Certification.count') do
      post :create, certification: { certification_authority: @certification.certification_authority, certification_name: @certification.certification_name, certification_number: @certification.certification_number, certification_url: @certification.certification_url }
    end
  ...
  test "should update certification" do
    patch :update, id: @certification, certification: { certification_authority: @certification.certification_authority, certification_name: @certification.certification_name, certification_number: @certification.certification_number, certification_url: @certification.certification_url }
    assert_redirected_to certification_path(assigns(:certification))
  end
